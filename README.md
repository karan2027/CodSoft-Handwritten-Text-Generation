...
![App Screenshot](handwriting-generation-master/screenshot.png)
...
![Loss plot](https://github.com/karan2027/handwriting-generation/blob/master/imgs/loss-plot.PNG)
...
![example-1](https://github.com/karan2027/handwriting-generation/blob/master/imgs/example-1.PNG)

```
python generate.py --noinfo --animation --text="example of animation " --bias=1.
```

![example-2](https://github.com/karan2027/handwriting-generation/blob/master/imgs/example-2.gif)
...
B.Tech Computer Science & Engineering student at Hemvati Nandan Bahuguna Garhwal University and a passionate Developer.

### Contact

**GitHub:** https://github.com/karan2027

**LinkedIn:** https://linkedin.com/in/chhotelal-kushwaha-2902a3329

**Email:** chhotelalkushwahak9628@gmail.com
